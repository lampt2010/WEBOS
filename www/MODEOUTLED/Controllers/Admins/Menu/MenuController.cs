...
namespace MODEOUTLED.Controllers.Admins.Menu
{
    public class MenuController : BaseController
    {
        ...
        public ActionResult MenuIndex(int? page)
        {
            ...
            var menu = db.Menus.Where(x=>x.Lang==Lang).OrderBy(m => m.Level).ToList();
            int pageSize = 20;
        ...
        public ActionResult Search(string searchString, int? page)
        {
            if (Request.Cookies["Username"] != null)
            {
                ...
                PagedList<onsoft.Models.Menu> menu = (PagedList<onsoft.Models.Menu>)db.Menus.Where(a =>a.Lang==Lang
                                                                                                       &  a.Name.ToUpper().Contains(searchString.ToUpper())).OrderByDescending(a => a.Level).ToPagedList(pageNumber, pageSize);
