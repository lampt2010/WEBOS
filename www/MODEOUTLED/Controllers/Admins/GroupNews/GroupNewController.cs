...
{
    public class GroupNewController : BaseController
    {
        ...
        public ActionResult GroupNewIndexot(int? page)
        {
            ...
            var all = db.GroupNews.Where(a=>a.Lang==Lang).OrderBy(g => g.Level).ToList();
        ...
        public ActionResult GroupNewCreateot()
        {
            ...
            var GroupNews = db.GroupNews.Where(g => g.Active == true && g.Lang==Lang).OrderBy(g => g.Level).ToList();
