...
{
    public class My_PartialviewController : BaseController
    {
        ...
        public ActionResult _MenuTop()
        {
            ...
            for (int i = cat.Count - 1; i > -1; i--)
            {
                ...
                if (catsub.Count > 0)
                {
                    ...
                    chuoimo += "<li><a href=\"" + cat[i].Link + "\" class=\"smoothScroll text-uppercase\">" + cat[i].Name + "</a>";
                    chuoi += "<ul>";
                    chuoimo += " <ul class='devmastermenu-submenu'>";
                    for (int k = 0; k < catsub.Count; k++)
                    {
                        ...
                        chuoimo += "<li><a href=\"" + catsub[k].Link + "\">" + catsub[k].Name + "</a></li>";
                    }
                    chuoi += "</ul></li>";
                    chuoimo += "</ul></li>";
                }
                else
                {
                    ...
                    chuoimo += "<li><a href=\"" + cat[i].Link + "\" class=\"text-uppercase\">" + cat[i].Name + "</a></li>";
                }
            }

            ViewBag.Cat = chuoi;
            ViewBag.Catmo = chuoimo;
            return PartialView();
        }
        #endregion
        // 1.
